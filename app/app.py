...
def inject_css() -> None:
    st.markdown(
        ...
        /* ── Custom components ── */
        .hero-wrap {
            background: linear-gradient(135deg, #0d2235 0%, #0a1626 60%, #091520 100%);
        ...
        /* ── Player header card ── */
        .player-header {
            background: linear-gradient(135deg, #0d2235, #091520);
            border: 1px solid #1a3a55;
            border-radius: 14px;
            padding: 20px 24px;
            margin-bottom: 18px;
        ...
        /* ── Sidebar brand ── */
        .sidebar-brand {
            background: linear-gradient(135deg, #0a1e33, #071220);
            border: 1px solid #1a3a55;
            border-radius: 10px;
            padding: 14px 16px;
            margin-bottom: 16px;
